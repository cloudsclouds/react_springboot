// @ts-nocheck
import { forwardRef, useCallback, useEffect, useRef, useState, type HTMLAttributes, type ComponentPropsWithoutRef } from "react"
...
export const ToolbarGroup = forwardRef<HTMLDivElement, ToolbarGroupProps>(({ children, className, ...props }, ref) => (
  <div
    ref={ref}
    role="group"
...
export const ToolbarSeparator = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof Separator>>(({ ...props }, ref) => (
